 ...
 */
export function readQuotedString(iterator: Iterator<basic.Token>): basic.Token[] {
...
export class Property extends Value {
    constructor(span: Span, private _name: StringValue, private _value: Value | undefined) {
        super(span);
    }
...
export class ParseResult {
    ...
    public getValueAtCharacterIndex(characterIndex: number, containsBehavior: ContainsBehavior): Value | undefined {
        assert(0 <= characterIndex, `characterIndex (${characterIndex}) cannot be negative.`);
